...
export const courses = [
  ...
  },
  {
    ...
    level: "Grundnivå",
    startDate: "29 augusti 2022",
    endDate: "31 oktober 2022",
    location: "Umeå",
    code: "5EL223",
    registerCode: "UMU-54207",
    rating: 0,
  },
  {
  ...
  },
  {
    ...
    description:
      "Kursen behandlar metaforer och konceptuella modeller, interaktionstekniker, naturligt språk, gester, direktmanipulation, datorstöd för samarbete, utvecklingsmetoder, designstöd, prototyper, verktyg, uppgiftsanalys och utvärderingstekniker.",
    prerequisite:
  ...
  },
  {
    ...
    prerequisite:
      "Minst 60 hp avklarade kurser inom huvudområdet Medieteknik eller minst två års sammanlagda studier som skall innefatta Databasteknik och webbaserade system, 7.5 hp (5TF048) eller Databasteknik, 7.5 hp (5DV120) eller motsvarande.",
